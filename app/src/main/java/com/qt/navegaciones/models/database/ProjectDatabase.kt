...
@Database(entities = arrayOf(CarEntity::class, PersonEntity::class, ClienteEntity::class, DetalleVentaEntity::class, InsumoEntity::class, ProductoEntity::class, RolEntity::class, UsuarioEntity::class, VehiculoEntity::class, VentaEntity::class ), version = 23)
